...
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join('artifacts','preproceessor.pkl')
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        This function is responsible for transforming the columns of the dataset into numerical values and scale them.
        '''
        try:
